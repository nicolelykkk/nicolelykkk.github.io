...
Promise.all(promises).then(function(data) {
    ...
    */
    ...
    svg.selectAll("path")
        ...
        .append("path")
            .attr("class", "state")
            .attr("d", path); //create the outlines of the map ---> d?
    ...
    */
    ...
    slider
        ...
        .property("max", shootingsData[shootingsData.length-1].year) //<--- ? why-1
    ...
    function updateMap(year) {
        ...
        .merge(c)
            ...
            .attr("cx", function(d) {
                ...
                var proj = projection([d.longitude, d.latitude]);
                return proj[1];
            }).attr("r", function(d) { return rScale(d.victims);}) // 10 ---> function
            .attr("opacity", 0.7)
            .attr("fill", "#CC0000");
...
function parseCSV(data) {
    ...
    d.victims = +data["Total Number of Victims"]; // x ---> +data.Total Number of Victims
